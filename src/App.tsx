...
import { Money, createEntry, updateWorkOrderData, createWorkOrder, learnClientData, learnCatalogItems } from './utils/helpers';
import { WorkOrder, LedgerEntry, OSStatus, Client, CatalogItem } from './types';
import './styles.css';

const GOOGLE_API_KEY = "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"; 

// Tipo para gerenciar as ações pendentes do Modal Genérico
type PendingAction = 
...
function AppContent() {
  const { 
    workOrders, setWorkOrders, clients, setClients, 
    catalogParts, setCatalogParts, catalogServices, setCatalogServices, 
    ledger, setLedger, settings, setSettings, 
    isLoading, isSaving 
  } = useDatabase();
